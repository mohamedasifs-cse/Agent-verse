...
function RouteInfoBar({ distanceM, durationS, stopsCount }) {
  ...
  return (
    <div style={{
      ...
      borderRadius: 24, padding: '7px 18px', backdropFilter: 'blur(12px)',
...
export default function ChargingMap({
  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative', borderRadius: 10, overflow: 'hidden' }}>
      ...
      {/* ── Trip Charging Strategy & Next Rest Stop Plan Panel ── */}
      {restStopPlan && restStopPlan.bestStop && (
        <div style={{
          ...
          borderRadius: 16, padding: '14px 20px', backdropFilter: 'blur(16px)',
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                ...
                <div style={{ fontFamily: 'var(--font-heading)', fontSize: 15, fontWeight: 900, color: '#fff' }}>
                  {restStopPlan.bestStop.name}
                </div>
              </div>
            </div>
            <div style={{ textAlign: 'right' }}>
              <span className="rydex-badge accent" style={{ fontSize: 11, fontWeight: 800 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8, background: 'rgba(15, 23, 42, 0.65)', padding: '10px 14px', borderRadius: 10, border: '1px solid rgba(255,255,255,0.06)' }}>
            <div>
              <div style={{ fontSize: 9, color: 'var(--text-muted)', fontWeight: 700, letterSpacing: '0.04em' }}>BATTERY ON ARRIVAL</div>
              <div style={{ fontSize: 13, fontWeight: 900, color: restStopPlan.socOnArrival < 15 ? '#ff5050' : '#22c55e' }}>
                {restStopPlan.socOnArrival}% SoC
              </div>
            </div>
            <div>
              <div style={{ fontSize: 9, color: 'var(--text-muted)', fontWeight: 700, letterSpacing: '0.04em' }}>STOP LOCATION</div>
              <div style={{ fontSize: 13, fontWeight: 900, color: '#00f0ff' }}>
                Km {restStopPlan.bestStop.distanceFromOriginKm || 240}
              </div>
            </div>
            <div>
              <div style={{ fontSize: 9, color: 'var(--text-muted)', fontWeight: 700, letterSpacing: '0.04em' }}>CHARGE DURATION</div>
              <div style={{ fontSize: 13, fontWeight: 900, color: '#d4d414' }}>
                {restStopPlan.chargeTimeMins} mins
              </div>
            </div>
            <div>
              <div style={{ fontSize: 9, color: 'var(--text-muted)', fontWeight: 700, letterSpacing: '0.04em' }}>REST AMENITIES</div>
